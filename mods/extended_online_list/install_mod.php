...
$mod_title      = 'Extended online list';
$mod_version    = '1.0';
...
function install()
{
	...
	$db->add_field('online', 'action', 'VARCHAR( 255 )', true);
	$db->add_field('online', 'url', 'VARCHAR( 255 )', true);
	$db->add_field('online', 'user_agent', 'VARCHAR( 255 )', true);
}
...
function restore()
{
	...
	$db->drop_field('online', 'action');
	$db->drop_field('online', 'url');
	$db->drop_field('online', 'user_agent');
}
