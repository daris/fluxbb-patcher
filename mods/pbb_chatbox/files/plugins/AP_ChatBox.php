				...
				<div class="inform">
						...
						<table class="aligntop" cellspacing="0">
							<tr>
								...
								<td>
									...
									<span>How many time betwteen each refresh of the chatbox ? (in second)</span>
								</td>
							<tr>
								<th scope="row">Errors Display (Parsing)</th>
								<td>
									<textarea name="form[ajax_errors]" rows="4" cols="45"><?php echo $pun_config['cb_ajax_errors'] ?></textarea>
									<span>How display the errors messages in your ChatBox. You can use HTML. <strong>Default exemple:</strong>
									  <textarea rows="4" cols="45"><strong>[<pun_error>]</strong> - <pun_date><br /><pun_error_text></textarea>
									  </span>
								</td>
							</tr>
						</table>
					...
					<fieldset>
						...
						<table class="aligntop" cellspacing="0">
							...
							<tr>
								<th scope="row">Messages sparation</th>
								<td>
									<textarea name="form[space]" rows="4" cols="45"><?php echo $pun_config['cb_space'] ?></textarea>
									<span>What would you display between each message ? You can use HTML. <strong>Default exemple:</strong>
								  <textarea rows="4" cols="45"><br /></textarea>
								  </span>
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="form[disposition]" rows="4" cols="45"><?php echo $pun_config['cb_disposition'] ?></textarea>
									<span>How display the messages in your ChatBox. You can use HTML. <strong>Default exemple:</strong>
                  <textarea rows="4" cols="45"><strong><pun_username></strong> - <pun_date> - [ <pun_nbpost><pun_nbpost_txt> ] <pun_admin><br /><pun_message></textarea>
                  </span>
								</td>
							</tr>
						</table>
