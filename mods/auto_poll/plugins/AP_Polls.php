...
if (isset($_POST['save_options']))
{
	...
	redirect('admin_loader.php?plugin=AP_Polls.php', 'Options updated. Redirecting &hellip;');
}
...
else if (isset($_POST['add_forum']))
{
	...
	redirect('admin_loader.php?plugin=AP_Polls.php', 'Forum added. Redirecting &hellip;');
}
...
else if (isset($_GET['del_forum']))
{
	...
	if (isset($_POST['del_forum_comply']))	// Delete a forum with all posts
	{
		...
		redirect('admin_loader.php?plugin=AP_Polls.php', 'Forum deleted. Redirecting &hellip;');
	}
...
else if (isset($_POST['update_positions']))
{
	...
	redirect('admin_loader.php?plugin=AP_Polls.php', 'Forums updated. Redirecting &hellip;');
}
...
else if (isset($_GET['edit_forum']))
{
	...
	if (isset($_POST['save']))
	{
		...
		redirect('admin_loader.php?plugin=AP_Polls.php', 'Forum updated. Redirecting &hellip;');
	}
	else if (isset($_POST['revert_perms']))
	{
		...
		redirect('admin_loader.php?plugin=AP_Polls.php&amp;edit_forum='.$forum_id, 'Permissions reverted to defaults. Redirecting &hellip;');
	}
...
?>
	<div class="block">
		<h2><span>Auto Poll - v<?php echo PLUGIN_VERSION ?></span></h2>
		<div class="box">
			<div class="inbox">
				<p>This plugin is used to control the settings and permissions for the polls mod.</p>
			</div>
		</div>
	</div>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="admin_loader.php?plugin=AP_Polls.php">
				<p class="submittop"><input type="submit" name="save_options" value="Save changes" /></p>
				<div class="inform">
					...
					<fieldset>
						...
						<table class="aligntop" cellspacing="0">
							<tr>
								<th scope="row">Enable polls</th>
								<td>
									<input type="radio" name="form[poll_enabled]" value="1"<?php if ($pun_config['o_poll_enabled'] == '1') echo ' checked="checked"' ?> />&nbsp;<strong>Yes</strong>&nbsp;&nbsp;&nbsp;<input type="radio" name="form[poll_enabled]" value="0"<?php if ($pun_config['o_poll_enabled'] == '0') echo ' checked="checked"' ?> />&nbsp;<strong>No</strong>
									<span>If no all poll functions will be disabled.</span>
								</td>
							</tr>
							<tr>
				...
				<div class="inform">
					<fieldset>
						<legend>Moderator permissions</legend>
						<div class="infldset">
						<table class="aligntop" cellspacing="0">
							<tr>
								<th scope="row">Delete polls</th>
								<td>
									<input type="radio" name="form[poll_mod_delete_polls]" value="1"<?php if ($pun_config['o_poll_mod_delete_polls'] == '1') echo ' checked="checked"' ?> />&nbsp;<strong>Yes</strong>&nbsp;&nbsp;&nbsp;<input type="radio" name="form[poll_mod_delete_polls]" value="0"<?php if ($pun_config['o_poll_mod_delete_polls'] == '0') echo ' checked="checked"' ?> />&nbsp;<strong>No</strong>
									<span>Allow moderators to delete polls.</span>
								</td>
							</tr>
							<tr>
								<th scope="row">Edit polls</th>
								<td>
									<input type="radio" name="form[poll_mod_edit_polls]" value="1"<?php if ($pun_config['o_poll_mod_edit_polls'] == '1') echo ' checked="checked"' ?> />&nbsp;<strong>Yes</strong>&nbsp;&nbsp;&nbsp;<input type="radio" name="form[poll_mod_edit_polls]" value="0"<?php if ($pun_config['o_poll_mod_edit_polls'] == '0') echo ' checked="checked"' ?> />&nbsp;<strong>No</strong>
									<span>Allow moderators to edit polls.</span>
								</td>
							</tr>
							<tr>
								<th scope="row">Reset polls</th>
								<td>
									<input type="radio" name="form[poll_mod_reset_polls]" value="1"<?php if ($pun_config['o_poll_mod_reset_polls'] == '1') echo ' checked="checked"' ?> />&nbsp;<strong>Yes</strong>&nbsp;&nbsp;&nbsp;<input type="radio" name="form[poll_mod_reset_polls]" value="0"<?php if ($pun_config['o_poll_mod_reset_polls'] == '0') echo ' checked="checked"' ?> />&nbsp;<strong>No</strong>
									<span>Allow moderators to reset polls.</span>
								</td>
							</tr>
						</table>
						</div>
			...
			<p class="submitend"><input type="submit" name="save_options" value="Save changes" /></p>
			</form>
		</div>
	</div>
...
?>
								<tr>
									<th><a href="admin_loader.php?plugin=AP_Polls.php&amp;edit_forum=<?php echo $cur_forum['fid'] ?>">Edit</a> - <a href="admin_loader.php?plugin=AP_Polls.php&amp;del_forum=<?php echo $cur_forum['fid'] ?>">Delete</a></th>
