			...
			<div class="inform">
				...
				?>
					...
					<div class="infldset">
							...
							{
							?>
								<label><strong><?php echo $lang_poll['Option'] ?></strong><br /> <input type="text" name="poll_option[<?php echo $x; ?>]" value="<?php echo isset($option[$x]) ? pun_htmlspecialchars($option[$x]) : '' ?>" size="60" maxlength="55" tabindex="<?php echo $cur_index++ ?>" /><br /></label>
							<?php
							} 
							?></div></fieldset><?php
				} 
