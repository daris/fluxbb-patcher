...
?>
	<div class="block">
		<h2><span>Attachment Mod 2.0.1 - Documentation</span></h2>
		<div class="box">
			<div class="inbox">
				...
				<p>Either way, I have tried to make this mod in such a way that it should be possible to use together with other mods (like creating a gallery that use attachments as a base). Hopefully it'll inspire someone else to write larger mods aswell. (And please oversee all spelling/grammatical errors in this documentation, hehehe, well if you find any you can always mail me the correct text)</p>
				...
				<p>The Attachment Mod use both it's own tables, aswell as use the forum config table for options (these were in the first version of the mod in php files, now you don't have to edit files anymore).</p>
				<p></p>
				...
				attach_max_size - The 'hard' limit of maximum upload, noone is allowed to upload larger attachments than this, not even Administrator.<br />
				...
				* attach_func.php - This file is included by attach_incl.php, it has the functions used in the mod.</p>
				...
				In all the basefolders and subfolders an index.html is stored, that shows and empty page. Also an .htaccess file is saved there (for Apache servers). This is so noone will be able to browse a folder.<br />
				...
				<p>* attach_check_extension(string extension, string allowed_extensions) - This function does an extension check, if it's in the 'always deny' list, it's refused, and if the strign for allowed extensions is logner than 0 then it will check against that aswell</p>
					...
					<fieldset>
						...
						<table class="aligntop" cellspacing="0">
							...
							<tr>
								...
								<td>
									<span>
										<form name="alter_attachment_id_'.$attach_id.'" id="example" method="post" action="'.$_SERVER['REQUEST_URI'].'">
											<input type="Submit" name="delete_attachment" value="Delete attachment" /><input type="hidden" name="attachment_id" value="'.$attach_id.'" />
										</form>
									</span>
								</td>
							</tr>
			...
			<div class="inbox">
				<div class="inform">
					...
					<fieldset>
						...
						<input type="submit" name="list_attachments" value="List Attachments" tabindex="11" />
						</div>
					</fieldset>
					</form>
				</div>
						...
						<table class="aligntop" cellspacing="0">
							...
							<tr>
								...
								<td>
									<span>
										<form name="alter_attachment_id_'.$attach_id.'" id="example" method="post" action="'.$_SERVER['REQUEST_URI'].'">
											<input type="Submit" name="delete_orphan" value="Delete attachment" /><input type="hidden" name="attachment_id" value="'.$attach_id.'" />
										</form>
									</span>
								</td>
							</tr>
		...
		foreach ($attach_rightsarray as $key => $value){
			...
			$attach_output .= '</legend>
							<div class="infldset">
								...
								<input type="submit" name="update_ruleset" value="Edit this ruleset" /> or 
								<input type="submit" name="delete_ruleset" value="Delete this ruleset" />
							</div>
						</fieldset>
					</form>
';
					...
					<form id="createnew" name="createnew" method="post" action="'.$_SERVER['REQUEST_URI'].'">
						<fieldset>
							...
							<div class="infldset">
								...
								<input type="hidden" name="forum" value="'.$attach_cur_f_id.'" />
								<input type="hidden" name="edit_rules" value="'.$attach_cur_f_id.'" />
								<input type="submit" name="create_ruleset" value="Create new ruleset" />
							</div>
						</fieldset>
					</form>
				</div>
					...
					<form id="example2" method="post" action="'.$_SERVER['REQUEST_URI'].'">
						<fieldset>
							...
							<div class="infldset">
								...
								<input type="hidden" name="forum" value="'.$attach_cur_f_id.'" /><input type="submit" name="edit_rules" value="Edit rules for this forum" />
							</div>
						</fieldset>
					</form>
';
					...
					<fieldset>
						...
						<table class="aligntop" cellspacing="0">
							...
							<tr>
								...
								<td>
									<input type="text" name="icon_folder" value="<?php echo $pun_config['attach_icon_folder']; ?>" tabindex="4" />
					...
					<fieldset>
						...
						<table class="aligntop" cellspacing="0">
							...
							<tr>
								...
								<td>
									<input type="text" name="basefolder" value="<?php echo htmlspecialchars($pun_config['attach_basefolder']); ?>" tabindex="11" />
						...
						<table class="aligntop" cellspacing="0">
							<tr>
								...
								<td>
									...
									<span><input type="submit" name="generate_subfolder" value="Generate new subfolder" tabindex="14" /> or <input type="submit" name="change_subfolder" value="Change subfolder" tabindex="15" /></span>
								</td>
							</tr>
						</table>
						</div>
