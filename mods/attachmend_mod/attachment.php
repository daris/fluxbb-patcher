...
<div id="msg" class="block">
	<h2><span><?php echo $lang_attach['Image view - Attachment Mod']; ?> <?php echo $pun_config['attach_cur_version'];?></span></h2>

	<div class="box">
		<div class="inbox">
		<div class="imgbox"><div class="scrollbox"><img src="attachment.php?item=<?php echo $_GET['item']; ?>&amp;download=1" alt="<?php echo $attach_filename; ?>" /></div></div><p>
		<?php echo $lang_attach['Download:']; ?> <a href="attachment.php?item=<?php echo $_GET['item']; ?>&amp;download=1"><?php echo $attach_filename; ?></a></p>
