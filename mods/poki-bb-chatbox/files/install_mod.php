...
function install()
{
	...
	$chatbox_config = array(
		...
		'cb_max_msg'		=> '100',
		'cb_disposition'	=> '<span class="conr posted"><pun_date></span><pun_admin><pun_guest><strong><pun_username></strong>: <pun_message>',
		'cb_ajax_refresh'	=> '5',
		'cb_ajax_errors'	=> '<span class="conr posted"><pun_date></span><strong><pun_error></strong>: <pun_error_text>',
		'cb_pbb_version'	=> $mod_version
	);
