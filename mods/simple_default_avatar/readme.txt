...
#
	...
	if (empty($avatar_markup) && file_exists(PUN_ROOT.$pun_config['o_avatars_dir'].'/default.png') && $img_size = getimagesize(PUN_ROOT.$pun_config['o_avatars_dir'].'/default.png'))
		$avatar_markup = '<img src="'.$pun_config['o_base_url'].'/'.$pun_config['o_avatars_dir'].'/default.png'.'?m='.filemtime(PUN_ROOT.PUN_ROOT.$pun_config['o_avatars_dir'].'/default.png').'" '.$img_size[3].' alt="" />';
