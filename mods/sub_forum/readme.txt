...
##               PS.  Fixed by daris:
##                     in version 1.0.9.5
##                      - index.php and viewforum.php optimalization
##                      - removing last topic title from index due to performance issues on big forums (you can use last_topic_on_index mod instead)
##                    Fixed by daris:
##                     in version 1.0.9.4
##                      - Updated to FluxBB 1.4.2
##                    Fixed by RoadTrain:
##                     in version 1.0.9.3
##                      - Updated to punBB 1.2.20
##                    Fixed by Smartys:
##                     in version 1.0.9.2
