...
'New Patcher version available'	=> 'You are using an outdated version of Patcher. %s (%s). If automatic update does not work, download Patcher from the %s and manually overwrite all files.',
